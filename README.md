...
Funcionalidades
Extração Multitag: Captura URLs em atributos href e src.
...
Como usar
Para executar o script, basta rodar o comando abaixo no terminal:
...
⚠️ Aviso Legal
Este script foi desenvolvido para fins educacionais e de pesquisa. O uso desta ferramenta para realizar atividades sem autorização prévia em sistemas de terceiros é de inteira responsabilidade do usuário. O autor não se responsabiliza por qualquer uso indevido.
